                    ...
                    <div class="login-card card-block auth-body mr-auto ml-auto">
                        <form class="md-float-material">
                            ...
                            <div class="auth-box">
                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        <p class="text-inverse text-left m-b-0">Not a member ?</p>
                                        <a class="text-inverse text-left" href="/registration"><p class="text-inverse text-left"><b>Create a new account</b></p></a>
                                    </div>
                                </div>
